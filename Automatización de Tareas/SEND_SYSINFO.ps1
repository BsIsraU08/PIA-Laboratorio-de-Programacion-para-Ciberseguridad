...
$array | Export-Csv -Path C:\Users\HP\Documents\FACU\test.csv -NoTypeInformation # Aqui se genera archivo csv
...
$path = "C:\Users\HP\Documents\FACU\test.csv";       # Aqui va la ruta de el archivo csv generado previamente
...
function Send-ToEmail([string]$email, [string]$attachmentpath){
    ...
    $message.Subject = "Envió de información de equipo."; #Asunto del correo

    $message.Body = "Buenas tardes, aqui te adjunto la información de mi equipo"; #Cuerpo o Mensaje del correo.
